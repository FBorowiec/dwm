...
static const char *fonts[] = {"JetBrains Mono",      "Fira Code",
                              "MesloLGS NF",         "Hack Nerd Font:size=10",
                              "FontAwesome:size=10", "monospace:size=10"};
...
static const char *colors[][3] = {
    ...
    [SchemeStatus] = {"#94d3f7", col_black,
                      "#000000"}, // Statusbar right {text,background,not used
                                  // but cannot be empty}
    [SchemeTagsSel] = {col_navyblue, col_black,
    ...
    // [SchemeWarn]   		=	 { col_black,     col_yellow,
    // col_red
    // }, [SchemeUrgent]		=	 { col_smthFG, 	  col_red,
    // col_red }, [SchemeTagUnderline] =	 { col_border,    col_border,
    // col_border }, [SchemeBGgreen] 	=	 { col_gray3,  	  col_BGgreen,
    // col_gray2 }, [SchemeWnameBG] 	=	 { col_border, 	  col_gray1,
    // col_red }, [SchemeBlockSeparator] 	=	 { col_cyan,
    // col_SeparatorBG,	col_red }, [SchemeCmusButton] 	=	 { col_smth,
    // col_cyan,		col_red },
};
...
static const Rule rules[] = {
    ...
    /*{ "Spotify",  "spotify",       "Spotify Free",       1 << 8,       0, -1
       }, This doesn't work unless you get smth like spotifywm*/
};
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){0, XF86XK_AudioLowerVolume, spawn, {.v = downvol}},
    ...
    {MODKEY | ShiftMask, XK_a, spawn,
     SHCMD("rofi -modi \"clipboard:greenclip print\" -show clipboard "
           "-run-command '{cmd}' -config ~/rofi-spotlight/rofi.rasi")},
